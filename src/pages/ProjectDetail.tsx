...
const projectsData: Record<string, {
  ...
  'vikingz-collection': {
    ...
    overview: 'A dedicated collection page for the Vikingz watch brand featuring an elegant grid layout that showcases the premium watch collection with detailed descriptions and pricing.',
    problem: 'Product pages often feel cluttered and fail to give each product the attention it deserves, especially for luxury items.',
    solution: 'I designed a clean grid layout that gives each watch ample space to shine. The card design includes product images, descriptions, and pricing in a visually appealing format.',
    features: [
    ...
    images: [vikingzCollection, vikingzHero, vikingzFooter],
    liveUrl: '#',
    sourceUrl: '#',
  },
  'elitewear-catalog': {
    title: 'EliteWear Product Catalog',
    description: 'Dynamic product catalog with filtering',
    overview: 'A comprehensive product catalog page for EliteWear featuring shoes and accessories. The page includes category sections, product cards with size selection, and a clean grid layout for easy browsing.',
    problem: 'E-commerce catalogs need to display many products while maintaining usability and visual appeal.',
    solution: 'I implemented a responsive grid system with clear category sections. Each product card includes essential information like pricing, size options, and action buttons for a streamlined shopping experience.',
    features: [
    ...
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'CSS Grid', 'Flexbox', 'Bootstrap'],
    images: [elitewearShoes, elitewearAccessories, elitewearContact, elitewearHero],
    liveUrl: '#',
    sourceUrl: '#',
  },
};
